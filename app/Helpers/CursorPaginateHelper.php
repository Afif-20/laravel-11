...
class CursorPaginateHelper
{
     ...
     * @return string|null
     */
    public static function previousCursor(CursorPaginator $paginator): string|null
    {
        // Ambil cursor sebelumnya
        $prevCursor = $paginator->previousCursor();

        // Jika ada: encode, jika tidak: null
        return $prevCursor ? $prevCursor->encode() : null;
    }
